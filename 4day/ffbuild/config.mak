...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--disable-stripping --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-avdevice --disable-devices --disable-indevs --disable-outdevs --disable-debug --disable-asm --disable-yasm --disable-doc --enable-small --enable-dct --enable-dwt --enable-lsp --enable-mdct --enable-rdft --enable-fft --enable-version3 --enable-nonfree --disable-filters --disable-postproc --disable-bsfs --enable-bsf=aac_adtstoasc --enable-bsf=h264_mp4toannexb --disable-encoders --enable-encoder=pcm_s16le --enable-encoder=aac --enable-encoder=libvo_aacenc --disable-decoders --enable-decoder=aac --enable-decoder=mp3 --enable-decoder=pcm_s16le --disable-parsers --enable-parser=aac --disable-muxers --enable-muxer=flv --enable-muxer=wav --enable-muxer=adts --disable-demuxers --enable-demuxer=flv --enable-demuxer=wav --enable-demuxer=aac --disable-protocols --enable-protocol=rtmp --enable-protocol=file --enable-libfdk_aac --enable-libx264 --enable-gpl --enable-cross-compile --prefix=/Users/kyleruan/Documents/GitHub/mediaLearn/4day/ffmpeg-output --target-os=darwin --cc='xcrun -sdk iphoneos clang' --arch=arm64 --extra-cflags='-arch arm64 -mios-version-min=8.0 -I/Users/kyleruan/Documents/GitHub/mediaLearn/4day/external/FDK-AAC/include -I/Users/kyleruan/Documents/GitHub/mediaLearn/4day/external/X264/include' --extra-ldflags='-arch arm64 -mios-version-min=8.0 -L/Users/kyleruan/Documents/GitHub/mediaLearn/4day/external/FDK-AAC/lib -L/Users/kyleruan/Documents/GitHub/mediaLearn/4day/external/X264/lib'
prefix=/Users/kyleruan/Documents/GitHub/mediaLearn/4day/ffmpeg-output
...
CFLAGS=  -arch arm64 -mios-version-min=8.0 -I/Users/kyleruan/Documents/GitHub/mediaLearn/4day/external/FDK-AAC/include -I/Users/kyleruan/Documents/GitHub/mediaLearn/4day/external/X264/include -std=c11 -Werror=partial-availability -mdynamic-no-pic -fomit-frame-pointer -fPIC -pthread  -I/usr/local/Cellar/x264/r2917_1/include -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-char-subscripts -Oz -fno-math-errno -fno-signed-zeros -mstack-alignment=16 -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type
CXXFLAGS=  -D__STDC_CONSTANT_MACROS -std=c++11
OBJCFLAGS=  
ASFLAGS=  -arch arm64 -mios-version-min=8.0 -I/Users/kyleruan/Documents/GitHub/mediaLearn/4day/external/FDK-AAC/include -I/Users/kyleruan/Documents/GitHub/mediaLearn/4day/external/X264/include -mdynamic-no-pic -fPIC -Qunused-arguments
...
DOXYGEN=doxygen
LDFLAGS= -arch arm64 -mios-version-min=8.0 -L/Users/kyleruan/Documents/GitHub/mediaLearn/4day/external/FDK-AAC/lib -L/Users/kyleruan/Documents/GitHub/mediaLearn/4day/external/X264/lib  -Wl,-dynamic,-search_paths_first -Qunused-arguments
LDEXEFLAGS=
LDSOFLAGS=
